...
<b>글수정</b>
<br>
<form method = "post" name = "writeForm" action = "/practiceWeb/board/updatePro.do?pageNum=${pageNum }"
...
<tr>
	<td colspan = "2" bgcolor = "${value_c }" align = "center">
		...
		<input type = "button" value = "목록보기" onclick = "document.location.href = '/practiceWeb/board/list.do?pageNum=${pageNum}'">
	</td>
</tr>
</table>
</form>
