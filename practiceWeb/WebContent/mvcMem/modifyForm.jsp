...
<tr>
	...
	<td>
		<select name = "phone1">
			...
			<option value = "02" ${phone1 eq '010' ? "selected = 'selected'" : 'null' }>010</option>
			<option value = "02" ${phone1 eq '011' ? "selected = 'selected'" : 'null' }>011</option>
			<option value = "02" ${phone1 eq '016' ? "selected = 'selected'" : 'null' }>016</option>
			<option value = "02" ${phone1 eq '017' ? "selected = 'selected'" : 'null' }>017</option>
			<option value = "02" ${phone1 eq '018' ? "selected = 'selected'" : 'null' }>018</option>
			<option value = "02" ${phone1 eq '019' ? "selected = 'selected'" : 'null' }>019</option>
		</select>&nbsp;-&nbsp;
